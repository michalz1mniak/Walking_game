...
class Player():
    def __init__(self):
        ...
        self.left_arm_body.position = 595, 40
        ...
        self.right_arm_body.position = 665, 40
        ...
        self.left_leg_body.position = 615, 125
        ...
        self.right_leg_body.position = 645, 125
        ...
        self.torso_head_joint = pymunk.PivotJoint(self.torso_body, self.head_body, (640, 40)) 
        self.torso_head_limit_joint = pymunk.RotaryLimitJoint(self.torso_body, self.head_body, -0.5, 0.5)

        self.torso_left_arm_joint = pymunk.PivotJoint(self.torso_body, self.left_arm_body, (620,40))
        ...
        self.torso_right_arm_joint = pymunk.PivotJoint(self.torso_body, self.right_arm_body, (660,40))
        ...
        self.torso_left_leg_joint = pymunk.PivotJoint(self.torso_body, self.left_leg_body, (625,125))
        ...
        self.torso_right_leg_joint = pymunk.PivotJoint(self.torso_body, self.right_leg_body, (655,125))
